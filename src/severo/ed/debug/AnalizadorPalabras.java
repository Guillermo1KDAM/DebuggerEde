...
public class AnalizadorPalabras {
	...
	/**
	 * Obtiene la primera ocurrencia m?ltiple de un caracter.
	 ...
	 * tanto la no' como la 't' y la 'o' ser?an m?ltiples.
	 * 
	 * @return el primer caracter m?ltiple, o 0 si no encuentra ninguno
	 */
